...
function(set_library_version _LIBRARY)
    set(_VERSION "${ARGN}")
    set(_SOVERSION "-")
    if(UNIX AND "${_VERSION}" STREQUAL "" AND EXISTS "${PROJECT_SOURCE_DIR}/cmake-abi.sh")
        execute_process(WORKING_DIRECTORY ${PROJECT_SOURCE_DIR} COMMAND "./cmake-abi.sh" OUTPUT_VARIABLE _VERSION OUTPUT_STRIP_TRAILING_WHITESPACE)
    endif()
